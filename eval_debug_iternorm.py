...
def parse_args():
    ...
    parser.add_argument('--setup', default='fine-tuning', required=False)
...
def main(args):
    ...
    test_metrics = trainer.test(model, datamodule=datamodule, ckpt_path="/media/jamshid/b0ad3209-9fa7-42e8-a070-b02947a78943/home/jamshid/git_clones/voxsep/vox2vec/evaluate_models_server/fine-tune_iternorm/best.ckpt")
