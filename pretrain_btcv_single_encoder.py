...
def parse_args():
    ...
    parser.add_argument('--pretrain_num_workers', type=int, default=1)
...
def main(args):
    ...
    in_channels = 1
    backbone = MySimpleEncoder(in_channels, args.base_channels, args.num_scales)
    model = Vox2Vec(
        backbone=backbone,
    ...
    heads = [
        SimpleLinearHead(args.base_channels, args.num_scales, num_classes),
        # SimpleNonLinearHead(args.base_channels, args.num_scales, num_classes)
    ]
