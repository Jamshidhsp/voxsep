...
class Vox2Vec(pl.LightningModule):
    def __init__(
        ...
        self.temp = temp
        self.lr = lr
        self.queue = Queue(max_size=6000, embedding_size=proj_dim)
    ...
    def training_step(self, batch, batch_idx):
        ...
        for i in range(embeds_1.size(0)):
            ...
            loss = (loss_ce_n_1+loss_ce_n_2 + loss_ce_p_1+loss_ce_p_2)/4


            # loss = torch.mean(-logits_neg +torch.logsumexp(torch.cat([logits_pos_1, logits_pos_2], dim=1), dim=1))
