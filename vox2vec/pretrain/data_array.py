...
def sample_views(
    ...
    # return patch_1, patch_2, roi_voxels_1[indices]
    ...
    while counter <sampling:
        ...
        if len(negative_voxels) == num_negative:
            if len(positive_voxels) == num_positives:
                ...
                counter+=1
    positive_list_all.append(np.stack(positive_list))
    negative_list_all.append(np.stack(negative_list))
    return np.stack(positive_list_all), np.stack(negative_list_all)
