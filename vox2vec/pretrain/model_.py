...
class Vox2Vec(pl.LightningModule):
    ...
    def neighboring_sampling(voxels, voxel_indice):
        num_positives = 10
        num_negative = 10
        step = 5
        # random_sample_indice = torch.randint(1, (1, voxels.shape[0]))
        random_sample_indice = random.randint(1, voxels.shape[0])
        # random_sample_voxel = voxels[random_sample_indice]
        # posisitve_indices = torch.randint(5, random_sample_indice+10)
        # positive_indices = [random.randint(random_sample_indice-10, random_sample_indice+10) for _ in range(num_positives)]
    ...
    def training_step(self, batch, batch_idx):
        ...
        '''
        number_crops = int(original_crops.size(0))
        print('# of crops I am using:', number_crops)
