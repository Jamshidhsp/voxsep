...
class Vox2Vec(pl.LightningModule):
    def __init__(
        ...
        self.temp = temp
        self.lr = lr
        self.queue = Queue(max_size=1000, embedding_size=512)
    ...
    def training_step(self, batch, batch_idx):
        ...
        embeds_1 = embeds_1.reshape(-1, num_positives, 512 )
        ...
        embeds_2 = embeds_2.reshape(-1, num_negative, 512)
