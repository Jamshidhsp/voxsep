...
from vox2vec.nn import FPN3d, FPNLinearHead, FPNNonLinearHead, FPN3d_iternorm
...
def main(args):
    ...
    # log_dir = "/media/jamshid/b0ad3209-9fa7-42e8-a070-b02947a78943/home/jamshid/git_clones/voxsep/vox2vec/evaluate_models_server/v1/"
    # test_metrics = trainer.test(model, datamodule=datamodule, ckpt_path=log_dir / 'checkpoints/best.ckpt')
    # test_metrics = trainer.test(model, datamodule=datamodule, ckpt_path="/media/jamshid/b0ad3209-9fa7-42e8-a070-b02947a78943/home/jamshid/git_clones/voxsep/vox2vec/evaluate_models_server/prob_iternorm/best.ckpt")
    test_metrics = trainer.test(model, datamodule=datamodule, ckpt_path=args.ckpt)
